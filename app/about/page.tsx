function AboutPage() {
  return (
    <section>
      <h1 className='flex flex-wrap gap-2 sm:gap-x-6 items-center justify-center text-4xl font-light leading-none trackiing-wide sm:text-6xl'>Shop with 
        <span className='text-primary logo'
        >
          Vita
        </span>
      </h1>
